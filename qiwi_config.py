...
bot = telebot.TeleBot('5932262133:AAFCkI73IJUEOi0JpQ0CSWWw2biGRt_ijeA')  # токен бота

admin = [5504563793] # айди одменов

amount = 5  # цена доступа

phone = '996705263660' # твой номер телефона qiwi

token = '8dad4e650cc877133bd175d5ec5912da' # твой токен кошелька киви
...
def remove_sub(message):
    try:
        ...
        bot.send_message(message.from_user.id,
                         "Упс... что-то пошло не так, проверьте правильность заданных данных. Помощь: @Licifer_exe")
        print(e)
...
def pay_many(message):
    try:
        ...
        bot.send_message(message.from_user.id, "Упс... что-то пошло не так, проверьте правильность заданных данных. Помощь: @Licifer_exe")
        print(e)
